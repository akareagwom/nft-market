...
const Register: React.FC<Props> = ({  }) => {
  return (
    <Box display={'flex'} flexDir={'column'} py={6} justifyContent={'center'} alignItems={'center'}>
      ...
      <Card.Root  mt={'10%'}  bgGradient="to-b" border='none' gradientFrom="rgb(35, 40, 43)" gradientTo="#060714"  color='white' borderRadius={'10px'} borderTopLeftRadius={'none'} px={2} mx={4} w={'80%'}>
